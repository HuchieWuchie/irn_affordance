...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", required=True, type=str,
                        help="The dataset you want to train on, allowed values: pascal, umd")
    ...
    dataset_root_path = ""
    if args.dataset == "umd":
        dataset_root_path = "umd_dataset/"
    elif args.dataset == "pascal":
        dataset_root_path = "voc12_dataset/"
    ...
    if args.train_cam_pass is True:
        ...
        step.train_cam.run(args, dataset_root_path)
